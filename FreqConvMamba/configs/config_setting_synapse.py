...
class setting_config:
    ...
    if datasets_name == 'synapse':
        data_path = 'The address where your data is stored/Synapse/train_npz/'
        datasets = Synapse_dataset
        list_dir = 'The address where your data is stored/Synapse/lists/lists_Synapse/'
        volume_path = 'The address where your data is stored/Synapse/test_vol_h5/'
    else:

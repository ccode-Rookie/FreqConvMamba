    ...
    def __init__(self, data_name, train=True):
        if data_name == 'isic18':
            ...
            if train:
                ...
                self.mean = 66.99
                self.std = 68.61
        elif data_name=='IDRIDMicroaneurysms':
            if train:
                self.mean = 63.08
                self.std = 67.44
            else:
                self.mean = 66.99
                self.std = 68.61
        elif data_name=='IDRIDHardExudates':
            if train:
                self.mean = 63.08
                self.std = 67.44
            else:
